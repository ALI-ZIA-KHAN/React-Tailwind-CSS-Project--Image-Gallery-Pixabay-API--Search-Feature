...
const ImageSearch=({ searchText })=>{
    ...
    return(
      ...
      <form onSubmit={onSubmit} className="w-full max-w-sm">
        ...
        <button className="flex-shrink-0 bg-green-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-sm border-4 text-dark py-1 px-2 rounded" type="submit">
      Search
      </button>
      </div>
      </form>
